...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add About Us</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="about-us.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View About Us  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                          ...
                          <div class="clearfix">
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  <label class="control-label">Our Vission:</label>
                                  <div class="controls">
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body form">
                                        ...
                                        <form action="#" class="form-horizontal">
                                            <div class="control-group">
                                                <label class="control-label">Our vission Description</label>
                                                <div class="controls">
