            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="become-a-dealer.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Dealers </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                        ...
                        <form action="#" class="form-horizontal clearfix">
                          <div class="clearfix">
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  <label class="control-label">Dealing In City:</label>
                                  <div class="controls">
