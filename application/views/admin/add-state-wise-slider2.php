               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">State Sliders</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="state-wise-slider2.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View State Sliders  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
