...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi || Requirement</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Requirement</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="post-requirement.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Requirement  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                     ...
                     <div class="widget-body form">
                        ...
                        <form action="#" class="form-horizontal clearfix">
                          <div class="clearfix">
                            ...
                            <div class="control-group">
                                  <label class="control-label">Budjet:</label>
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">10-20 lac</option>
                                        <option value="Category 2">10-20 lac</option>
                            ...
                            <div class="control-group">
                                <label class="control-label">Construction Status:</label>
                                <div class="controls">
                                    <label class="radio">
                                    <div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><input type="radio" name="optionsRadios1" value="option1" style="opacity: 0;"></span></div></span></div>
                                    Under Construction
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">Sq-ft</option>
                                        <option value="Category 2">Sq-ft</option>
                            ...
                            <div class="control-group">
                                <label class="control-label">Receive alerts for:</label>
                                <div class="controls">
                                    <label class="radio">
                                        <div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><input type="radio" name="optionsRadios1" value="option1" style="opacity: 0;"></span></div></span></div>
                                        Property
                            ...
                            <div class="span6">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">Residential House</option>
                                        <option value="Category 2">Residential House</option>
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">1 BHK</option>
                                        <option value="Category 2">2 BHK</option>
                               ...
                               <div class="control-group">
                                  <label class="control-label">Floor reference:</label>
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">Below 10th floor</option>
                                        <option value="Category 2">Below 10th floor</option>
                              ...
                              <div class="control-group">
                                <label class="control-label">I am in:</label>
                                <div class="controls">
                                    <label class="radio">
                                    <div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><input type="radio" name="optionsRadios1" value="option1" style="opacity: 0;"></span></div></span></div>
                                    Indivisual
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                <label class="control-label">Alerts Frequency:</label>
                                <div class="controls">
                                    <label class="radio">
                                        <div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><input type="radio" name="optionsRadios1" value="option1" style="opacity: 0;"></span></div></span></div>
                                        Daily 
