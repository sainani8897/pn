...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add Area</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Area</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="area-values.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Areas  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
