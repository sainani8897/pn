...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add Home Scroller</title>
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        <!-- BEGIN FORM-->
                        <form action="<?php echo base_url() ?>admin/scrolls/scroll_insert" method="post" class="form-horizontal clearfix">
                          <div class="clearfix">
                            <div class="span6">
                             ...
                             <!--   <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend">
                                            ...
                                            <input readonly name="date" type="text" class="span12 date-range" data-validation="required">
                                        </div>
                                    </div>
                                </div> -->
                                <div class="control-group">
                                  <label class="control-label">Scrolling-URL:</label>
                                  <div class="controls">
                                   <input  name="url" data-validation="required" type="text" class="span12 " data-validation="required url">
                                  </div>
                               </div>
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <textarea name="scroll_text" class="span12" data-validation="required" rows="5"></textarea>
                                  </div>
                               </div>
                            ...
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select name="status" class="span12 " data-validation="required" data-placeholder="Choose a Category" tabindex="1">
