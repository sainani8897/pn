...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi||Builder</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="builders.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Builders  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        ...
                        <div class="clearfix m-b-30">
                            <div class="span6">
                              <h5 class="heding"><b>Builder Details:</b></h5>
                            ...
                            <div class="control-group">
                               ...
                               <div class="control-group">
                                  <label class="control-label">No.of Ongoing projects:</label>
                                  <div class="controls">
                                    <input type="text" class="span12">
                                  </div>
                               </div>
                               <div class="control-group">
                                  <label class="control-label">No.of Completed projects:</label>
                                  <div class="controls">
                                    <input type="text" class="span12">
                                  </div>
                               </div>
