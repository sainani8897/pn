         ...
         <div class="container-fluid">
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Edit Banners</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
            ...
            <div class="row-fluid">
               <div class="span12">
                ...
                <?php } ?>
                        <form action="<?php echo base_url() ?>admin/banners/banner_update" method="post" enctype="multipart/form-data" class="form-horizontal clearfix">
                          <div class="clearfix">
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" readonly value="<?php  echo $banner['title'] ?>" name="title" data-validation="required" class="span12">
                                  </div>
                               </div>
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" readonly value="<?php  echo $banner['sort_order'] ?>" name="sort_order" data-validation="number required" class="span12">
                                  </div>
                               </div>
                               ...
                               <div class="control-group img-add">
                                  <label class="control-label">
                                    ...
                                    <img src="<?php echo base_url().$banner['image']?>"  width="60" height="60" class="img-responsive">
                               </div>
                            ...
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" readonly value="<?php  echo $banner['url'] ?>" name="url"  data-validation="url" class="span12">
                                  </div>
                               </div>
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " readonly name="status" data-placeholder="Choose a Category" data-validation="required" tabindex="1">
                          ...
                          <input type="hidden" name="old_photo" value="<?php echo $banner['image']?>">
                          <input type="hidden" name="banner_id" value="<?php echo $banner['banner_id'] ?>">
                          
                          <div class="clearfix">
                            <div class="span12 text-right">
                              <a href="<?php echo base_url() ?>admin/banners/banner/" class="btn btn-large btn-warning">Ok</a>
                            </div>
                          </div>
                        </form>
                        <!-- END FORM-->           
