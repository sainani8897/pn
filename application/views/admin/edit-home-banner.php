                          ...
                          <div class="clearfix">
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" value="<?php  echo $banner['title'] ?>" name="title" data-validation="required" class="span12">
                                  </div>
                               </div>
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" value="<?php  echo $banner['sort_order'] ?>" name="sort_order" data-validation="number required" class="span12">
                                  </div>
                               </div>
                               ...
                               <div class="control-group img-add">
                                  <label class="control-label">
                                    ...
                                    <div class="controls">
                                       ...
                                       <input value="<?php  echo $banner['image'] ?>" name="photo" data-validation=""  type="file" class="default"  data-validation-error-msg="Please Select an Image" 
     data-validation-error-msg-container="#email-error-dialog">
                            ...
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" value="<?php  echo $banner['url'] ?>" name="url"  data-validation="url" class="span12">
                                  </div>
                               </div>
