...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi||Add-Projects</title>
      ...
      <div id="sidebar" class="nav-collapse collapse">
        ...
        <li class="has-sub">
          ...
          <ul class="sub">
            ...
            <li><a class="" href="#">Franchises</a></li>
            <li><a class="" href="#">Dealers</a></li>
            <li><a class="" href="#">Users</a></li>
          </ul>
        </li>
        <li class="has-sub">
          <a href="javascript:;" class="">
          <span class="icon-box"><i class="icon-arrow-right"></i></span>Buy
          <span class="arrow"></span>
          </a>
          <ul class="sub">
                ...
                <li class="has-sub">
                    <a href="javascript:;" class="">
                        <span class="icon-box"><i class="icon-arrow-right"></i></span> Projects
                        <span class="arrow"></span>
                    </a>
                    <ul class="sub">
                        <li><a class="" href="#">Projects</a></li>
                        <li><a class="" href="#">Subscription Packages</a></li>
                        <li><a class="" href="#">Subscribers</a></li>
                    </ul>
                </li>
        <li><a class="" href="#"><span class="icon-box"><i class="icon-arrow-right"></i></span>Services</a></li>
        <li><a class="" href="#"><span class="icon-box"><i class="icon-arrow-right"></i></span> Info</a></li>
        
        <li><a class="" href="#"><span class="icon-box"><i class="icon-user"></i></span> Values</a></li>
      </ul>
         <!-- END SIDEBAR MENU -->
      </div>
      <!-- END SIDEBAR -->
               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Edit Projects</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                  <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="projects.html" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Projects  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
               ...
               <div class="span12">
                  <div class="widget box blue" id="form_wizard_1">
                     <div class="widget-title">
                        <h4>
                           <i class="icon-reorder"></i> Edit Projects - <span class="step-title">Step 1 of 4</span>
                        </h4>
                        <span class="tools">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                        <select class="span6" data-placeholder="Choose a Category" tabindex="1">
                                          ...
                                          <option value="Category 3">Sub Category 5</option>
                                          <option value="Category 4">Sub Category 4</option>
                                       </select>
                                       </div>
                                    </div>
                                    <div class="control-group">
                                       <label class="control-label">Subscriptiuon type:</label>
                                       <div class="controls">
                                        <select class="span6" data-placeholder="Choose a Category" tabindex="1">
                                            <option value="">Select...</option>
                                            <option value="Category 1">Subscriptiuon 1</option>
                                            <option value="Category 2">Subscriptiuon 2</option>
                                            <option value="Category 3">Subscriptiuon 5</option>
                                            <option value="Category 4">Subscriptiuon 4</option>
                                         </select>
                                       </div>
                                    </div>
                                 </div>
