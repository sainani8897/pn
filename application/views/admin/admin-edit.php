            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="admins.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Admins  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        ...
                        <div class="clearfix m-b-30">
                          ...
                          <div class="clearfix">
                            <div class="span6">
                              <h5 class="heding"><b>Employee Details:</b></h5>
                              <div class="control-group">
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">Role 1</option>
                                        <option value="Category 2">Role 2</option>
                                        <option value="Category 3">Role 5</option>
                                        <option value="Category 4">Role 4</option>
                                     </select>
                                  </div>
                               </div>
