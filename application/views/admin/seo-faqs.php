...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Seo Faqs</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Faqs-Seo </a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="chn">
                    <span class="pull-right"><a href="seo.php" class="btn btn-primary"><i class="icon-plus icon-white"></i> View Faqs </a></span>
                   </div> 
               </div>
            </div>
            <!-- END PAGE HEADER-->
