...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi||Admins-Edit</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Buy Properties</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="projects.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Projects  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                        ...
                        <form action="#" class="form-horizontal clearfix">
                          <div class="clearfix">
                            <div class="span6">
                               ...
                               <div class="control-group">
                                <label class="control-label">Ready to Move:</label>
                                <div class="controls">
                                    <label class="radio">
                            ...
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  <label class="control-label">Price for Sq.ft:</label>
                                  <div class="controls">
                                      <input type="text" class="span12">
                                  </div>
                               </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" value="" style="opacity: 0;"></span></div> Car Parking
                                        </label>
                                        <label class="checkbox">
                                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" value="" style="opacity: 0;"></span></div> Water Source
                                        </label>
                                        <label class="checkbox">
                                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" value="" style="opacity: 0;"></span></div> Security
                                        </label>
                                        <label class="checkbox">
                                        <div class="checker" id="uniform-undefined"><span><input type="checkbox" value="" style="opacity: 0;"></span></div> Swimmingpool
                                        </label>
                                    </div>
                                </div>
                          ...
                          <div class="clearfix">
                            <div class="span6">
                              <h5 class="heding"><b>Property Details:</b></h5>
                              <div class="control-group">
                            ...
                            <div class="span6">
                              <h5 class="heding"><b>Property Details:</b></h5>
                                ...
                                <div class="control-group">
                                    <label class="control-label">Property Sale Type:</label>
                                    <div class="controls">
                                        <label class="radio">
                                        ...
                                        <label class="radio">
                                        <div class="radio" id="uniform-undefined"><span class="checked"><div class="radio" id="uniform-undefined"><span class="checked"><input type="radio" name="optionsRadios1" value="option2" checked="" style="opacity: 0;"></span></div></span></div>
                                        Old
                                        </label>  
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">Home</option>
                                        <option value="Category 2">Village</option>
                                        <option value="Category 3">Flat</option>
                          ...
                          <div class="clearfix">
                            <div class="span6">
                              <h5 class="heding"><b>Contact Person Details:</b></h5>
                               <div class="control-group">
                            ...
                            <div class="span6">
                              <h5 class="heding"><b>Contact Person Details:</b></h5>
                               ...
                               <div class="control-group">
                                    <label class="control-label">Builder Name</label>
                                    <div class="controls">
                                        <input class="span12" size="16" type="text">
                                    </div>
                               </div>
                          ...
                          <div class="clearfix">
                            <div class="span6">
                            <h5 class="heding"><b>Property Description:</b></h5>
                            ...
                            <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        ...
                                        <option value="Category 2">Andrapradesh</option>                                       
                                     </select>
                                  </div>
                               </div>
                               ...
                               <div class="control-group">
                                  <label class="control-label">Number Of Short List:</label>
                                  <div class="controls">
                                      <input type="text" class="span12">
                                  </div>
                               </div>
                          ...
                          <div class="clearfix">
                            ...
                            <div class="span6">
                            <h5 class="heding"><b>Gallery:</b></h5>
