...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi || Add Package</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="packages.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Modules </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
