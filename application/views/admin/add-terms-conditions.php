...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add Terms & Conditions</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Terms & Conditions</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="terms-conditions.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Terms & Conditions  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
