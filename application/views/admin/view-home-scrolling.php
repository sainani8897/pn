                ...
                <?php } ?>
                        ...
                        <form action="" class="form-horizontal clearfix" method="post">
                          ...
                          <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <input name="url" readonly value="<?php echo $scrolls['link']; ?>" type="text" data-validation="url required" class="span12">
                                  </div>
                           </div>
                            ...
                            <div class="control-group">
                                  ...
                                  <div class="controls">
                                    <textarea readonly name="scroll_text" data-validation="required" class="span12" rows="5"><?php echo  $scrolls['scroll_name'] ?></textarea>
                                  </div>
                              </div>
                            ...
                            <div class="span6">
                              ...
                              <input type="hidden" readonly name="scroll_id" value="<?php echo $scrolls['sid']  ?>">
                              

                               <div class="control-group">
                                  <label class="control-label">Sort Order</label>
                                  <div class="controls">
                                  <input type="text" readonly name="sort_order" value="<?php echo  $scrolls['sort_order'] ?>" data-validation="required number" class="span12">
                                  </div>
                               </div>
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select readonly name="status" data-validation="required" class="span12 " data-placeholder="Choose a Category" tabindex="1">
                          ...
                          <div class="clearfix">
                            <div class="span12 text-right">
                              <a href="<?php echo base_url() ?>admin/scrolls/scroll/" class="btn btn-large btn-warning">OK</a>
                            </div>
                          </div>
                        </form>
                        <!-- END FORM-->           
