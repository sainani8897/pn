...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi || Add-Admin</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Employees</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="admins.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Employee  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        ...
                        <form action="#" class="form-horizontal clearfix">
                            ...
                            <div class="span6">
                              <h5 class="heding"><b>Company Details:</b></h5>
                               ...
                               <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class=" span12  date-picker" size="16" type="text" value="12-02-2012">
                                    </div>
                               </div>
                               <div class="control-group">
                              ...
                              <h5 class="heding"><b>Personal Details:</b></h5>
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">Applied for 1</option>
                                        <option value="Category 2">Applied for 2</option>
                                        <option value="Category 3">Applied for 5</option>
                                        <option value="Category 4">Applied for 4</option>
                                     </select>
                                  </div>
                               </div>
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                     <select class="span12 " data-placeholder="Choose a Category" tabindex="1">
                                        <option value="">Select...</option>
                                        <option value="Category 1">Status1</option>
                                        <option value="Category 2">Status2</option>
                                        <option value="Category 3">Status3</option>
                                        <option value="Category 4">Status4</option>
                                     </select>
                                  </div>
                               </div>
                            </div>
                          ...
                          <div class="clearfix">
                            <div class="span6">
                              <h5 class="heding"><b>Education & Certifications:</b></h5>
                               <div class="control-group">
                                  <label class="control-label">Degree/Certification:</label>
                                  <div class="controls">
                                      <input type="text" class="span12">
                                  </div>
                               </div>
                            ...
                            <div class="span6">
                              <h5 class="heding span12"><b>Education & Certifications:</b></h5>
                               <div class="control-group">
                                    <label class="control-label">Time Period:</label>
                                    <div class="controls">
                                        <div id="form-date-range" class="btn">
                                            <i class="icon-calendar"></i>
                                            &nbsp;<span>June 10, 2018 - July 9, 2018</span>
                                            <b class="caret"></b>
                                        </div>
                                    </div>
                                </div>
                          ...
                          <div class="clearfix">
                            <div class="span6">
                              <h5 class="heding"><b>Work Experience:</b></h5>
                               <div class="control-group">
                            ...
                            <div class="span6">
                              <h5 class="heding span12"><b>Work Experience:</b></h5>
                              <div class="control-group">
                               ...
                               <div class="control-group">
                                    <label class="control-label">Work Span:</label>
                                    <div class="controls">
                                        <div id="form-date-range" class="btn">
                                            <i class="icon-calendar"></i>
                                            &nbsp;<span>June 10, 2018 - July 9, 2018</span>
