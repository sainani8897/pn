...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add Glossary</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="glossary.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Glossary  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                          ...
                          <div class="clearfix">
                            <div class="span6">
                               ...
                               <div class="control-group">
                                  <label class="control-label">Glossary Name:</label>
                                  <div class="controls">
