...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi||User</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="users.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Users  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        ...
                        <div class="clearfix m-b-30">
                            <div class="span6">
                              <h5 class="heding"><b>User Details:</b></h5>
