...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi || Add Property</title>
                 ...
                 Property
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Property</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="post-property.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Property </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                          ...
                          <div class="clearfix">
                            <div class="span6">
                              ...
                              <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><input type="radio" name="optionsRadios1" value="option1" style="opacity: 0;"></span></div></span></div></span></div>
                                        Owner
                                        </label>
                                        <label class="radio">
                                        <div class="radio" id="uniform-undefined"><span class="checked"><div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><input type="radio" name="optionsRadios1" value="option2" checked="" style="opacity: 0;"></span></div></span></div></span></div>
                                        Agent
                                        </label>  
                                        <div class="radio" id="uniform-undefined"><span class="checked"><div class="radio" id="uniform-undefined"><span><div class="radio" id="uniform-undefined"><span><input type="radio" name="optionsRadios1" value="option2" checked="" style="opacity: 0;"></span></div></span></div></span></div>
                                        Builder
