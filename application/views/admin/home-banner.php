               ...
               <div class="span12">
                  ...
                  Banners
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">Banners</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="#">Home Banners</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   <div class="chn">
                   <span class="pull-right"><a href="<?php echo base_url() ?>admin/banners/banner_add" class="btn btn-primary"><i class="icon-plus icon-white"></i> Add Home Banner </a></span>
                   </div>
                        ...
                        <div class="widget-body">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th>S.No</th>
                                    <th class="hidden-phone">BANID</th>
                            ...
                            <tbody>
                              <?php $i=0; foreach ($banner->result() as $bann) {?>
                                <tr class="odd gradeX">
                                    <!-- <td><input type="checkbox" class="checkboxes" value="1" /></td> -->
                                    <td>1</td>
                                    <td>BAN<?=$bann->banner_id?></td>
                                    <td class="hidden-phone img-size"><img src="<?php echo base_url().$bann->image ?>" height="50" width="50" class="img-responsive"></td>
                                    <!-- <td class="hidden-phone">Propert Nidhi Slider</td> -->
                                    <td class="center hidden-phone"><?=$bann->url?></td>
                                    <td class="hidden-phone">
                                      <?php if ($bann->status == 1): ?>
                                    ...
                                    <td class="hidden-phone" width="160px">
                                      <a class="dropdown-toggle element icons" data-placement="top" data-toggle="tooltip" href="<?php echo base_url() ?>admin/banners/banner_edit/<?php echo $bann->banner_id ?>" data-original-title="Edit">
                                       <i class="icon-edit"></i>
                                      </a>
                                      <a class="dropdown-toggle element icons green" data-placement="top" data-toggle="tooltip" href="<?php echo base_url() ?>admin/banners/banner_view/<?php echo $bann->banner_id ?>" data-original-title="View">
                                       <i class="icon-eye-open"></i>
                                      </a>
                                      <a class="dropdown-toggle element icons red"  data-toggle="modal" onclick="deleteRecord(<?php echo $bann->banner_id ?>)" href="#deleteEmployeeModal">
   ...
   <div id="deleteEmployeeModal" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="<?php echo base_url() ?>admin/banners/banner_delete" method="post">
