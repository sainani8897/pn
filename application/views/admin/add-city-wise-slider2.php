...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add City Wise Slider</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li>
                           <a href="#">Sub Sliders</a> <span class="divider">&nbsp;</span>
                       </li>
                       <li><a href="#">City Sliders</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="city-wise-slider2.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View City Sliders  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
