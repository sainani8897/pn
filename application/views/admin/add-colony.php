...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi||Colony</title>
               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Colony</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="info-colony.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Colonies  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        ...
                        <div class="clearfix m-b-30">
                            <div class="span6">
                              <h5 class="heding"><b>Colony Details:</b></h5>
                               ...
                               <div class="control-group">
                                  <label class="control-label">Colony Since:</label>
                                  <div class="controls">
                                      <input type="text" class="span12">
                                  </div>
                               </div>
                               ...
                               <div class="control-group">
                                  ...
                                  <div class="controls">
                                      <input type="text" class="span12" placeholder="2 acres">
                                  </div>
                               </div>

                                <div class="control-group">
                                  <label class="control-label">Survey Number:</label>
                                  <div class="controls">
                                      <input type="text" class="span12">
                                  </div>
                               </div>
                            ...
                            <div class="span6">
                              <h5 class="heding"><b>Colony Details:</b></h5>
                               ...
                               <div class="control-group">
                                  <label class="control-label">Approval Number:</label>
                                  <div class="controls">
                                      <input type="text" class="span12">
                                  </div>
                               </div>
                               ...
                               <div class="control-group">
                                  <label class="control-label">Rent min-max:</label>
                                  <div class="controls">
                                      <input type="text" class="span12" >
                                  </div>
                               </div>
                         ...
                         <div class="clearfix">
                            <div class="span6">
                                <h5 class="heding"><b>Market Values:</b></h5>
                                ...
                                <div class="control-group">
                                    <label class="control-label">Governmet Card Value:</label>
                                    <div class="controls">
                                        <input type="text" class="span12" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label">Open Market Price Growth:</label>
                                    <div class="controls">
                                        <input type="text" class="span12" >
                                    </div>
                                </div>
                         ...
                         <div class="clearfix">
                            <div class="span6">
                                <h5 class="heding"><b>Amenities:</b></h5>
                                <div class="control-group">
                                    <label class="control-label">Amenities:</label>
                                    <div class="controls">
                                        <label class="checkbox">
                                        <div class="checker" id="uniform-undefined"><span><div class="checker" id="uniform-undefined"><span><input type="checkbox" value="" style="opacity: 0;"></span></div></span></div> Play Ground
                                        </label>
                                        <label class="checkbox">
                                        <div class="checker" id="uniform-undefined"><span><div class="checker" id="uniform-undefined"><span><input type="checkbox" value="" style="opacity: 0;"></span></div></span></div> Play Ground
                                        </label>
                          ...
                          <div class="clearfix">
                            <div class="span6">
                                <h5 class="heding"><b>Fresh Water:</b></h5>
                                
                                <div class="control-group">
                                  <label class="control-label">Ground Water Level:</label>
                                  <div class="controls">
                                        <input type="text" class="span12" >
                                    </div>
                               </div>
                                <div class="control-group">
                                    <label class="control-label">Length of deep:</label>
                                    <div class="controls">
                                        <input type="text" class="span12" >
                                    </div>
                                </div>
                            ...
                            <h5 class="heding"><b>Fresh Water:</b></h5>
                                <div class="control-group">
                                    <label class="control-label">Freshwater supply:</label>
                                    <div class="controls">
                                        <input type="text" class="span12" >
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">Storage tank:</label>
                                    <div class="controls">
                                        <input type="text" class="span12" >
                                    </div>
                                </div>
                         ...
                         <div class="clearfix">
                            <div class="span6">
                                <h5 class="heding"><b>Official Contacts:</b></h5>
