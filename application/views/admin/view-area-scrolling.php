...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add Area Scrolling</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="area-scrolling.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Area Scrolling  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
