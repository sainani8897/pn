               ...
               <div class="span12">
                  ...
                  <div class="spn6">
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Add Faqs</a><span class="divider-last">&nbsp;</span></li>
                   </ul>
                   </div>
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="faqs.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Faqs  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
