...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi || Add Faqs</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="customer-services.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View Modules </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
