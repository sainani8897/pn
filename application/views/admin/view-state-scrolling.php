...
<head>
   <meta charset="utf-8" />
   <title>Property Nidhi ||Add State Scrolling</title>
            ...
            <div class="row-fluid">
               <div class="span12">
                  ...
                  <div class="spn6">
                   ...
                   <div class="spn6 chn">
                   <span class="pull-right spn6"><a href="state-scrolling.php" class="btn btn-primary"><i class="icon-eye-open icon-white"></i> View State Scrolling  </a></span>
                   </div>
               </div>
            </div>
            <!-- END PAGE HEADER-->
                               ...
                               <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-prepend">
                                            ...
                                            <input type="text" class="span12 date-range">
                                        </div>
                                    </div>
                                </div>
